            ...
            switch (actionId) {
                ...
                case ModalsEnum.TRIGGER_ISSUE_DISPLAY_MODAL: {
                    ...
                    return context
                        ...
                        .updateModalViewResponse(issueDisplayModal);
                }
                case ModalsEnum.SWITCH_ISSUE_SORT:
                case ModalsEnum.SWITCH_ISSUE_STATE:
                case ModalsEnum.SWITCH_ISSUE_FILTER: {
                    const record = new RocketChatAssociationRecord(
                        RocketChatAssociationModel.MISC,
                        "ISSUE_MAIN_FILTER",
                    );

                    const issueFilterArray = (await this.read
                        .getPersistenceReader()
                        .readByAssociation(record)) as {
                        filter: string;
                        state: string;
                        sort: string;
                        order: string;
                    ...
                    const prev_sort =
                        issueFilterArray.length == 0
                            ? ModalsEnum.ISSUE_SORT_CREATED
                            : issueFilterArray[0].sort;
                    const prev_filter =
                        issueFilterArray.length == 0
                            ? ModalsEnum.ASSIGNED_ISSUE_FILTER
                            : issueFilterArray[0].filter;
                    const prev_state =
                        issueFilterArray.length == 0
                            ? ModalsEnum.ISSUE_STATE_OPEN
                            : issueFilterArray[0].state;
                    ...
                    return context
                        .getInteractionResponder()
                        .updateModalViewResponse(issueModal);
                }
                case ModalsEnum.TRIGGER_ISSUES_MODAL: {
                    ...
                    return context
                        .getInteractionResponder()
                        .openModalViewResponse(issuesModal);
                }
                ...
                case ModalsEnum.DELETE_SUBSCRIPTION_ACTION: {
                    ...
                    if (splitted.length == 2 && accessToken.token) {
                        ...
                        await sendNotification(
                            ...
                            user,
                            userRoom,
                            `Unsubscribed to ${repoName} 🔕`,
                        );
                    }

                    const modal = await deleteSubscriptionsModal({
                        modify: this.modify,
                        read: this.read,
                        persistence: this.persistence,
                        http: this.http,
                ...
                case ModalsEnum.MULTI_SHARE_ADD_SEARCH_RESULT_ACTION: {
                    ...
                    if (user?.id) {
                        ...
                        if (searchResultData?.search_results?.length) {
                            ...
                            if (index !== -1) {
                                searchResultData.search_results[index].share =
                                    true;
                ...
                case ModalsEnum.MERGE_PULL_REQUEST_ACTION: {
                    ...
                    if (splittedValues.length == 2 && accessToken?.token) {
                        ...
                        if (
                            ...
                            repoDetails?.permissions?.maintain
                        ) {
                ...
                case ModalsEnum.COMMENT_PR_ACTION: {
                    ...
                    if (splittedValues.length == 2 && accessToken?.token) {
                        ...
                        const addPRCommentModal =
                            await addPullRequestCommentsModal({
                                data: data,
                                modify: this.modify,
                                read: this.read,
                                persistence: this.persistence,
                ...
                case ModalsEnum.SHARE_PROFILE: {
                    ...
                    return context
                        .getInteractionResponder()
                        .openModalViewResponse(shareProfileMod);
                }
                    ...
                    if (user?.id) {
                        ...
                        if (room) {
                            ...
                            if (repoIssuesData?.issue_list?.length) {
                                ...
                                if (index !== -1) {
                                    repoIssuesData.issue_list[index].share =
                                        true;
                ...
                case ModalsEnum.TRIGGER_ASSIGN_ISSUES_MODAL: {
                    ...
                    return context
                        .getInteractionResponder()
                        .openModalViewResponse(assignIssuesModal);
                }
                ...
                case ModalsEnum.TRIGGER_SUBSCRIPTIONS_MODAL: {
                    ...
                    return context
                        .getInteractionResponder()
                        .openModalViewResponse(opensubscriptionsModal);
                }
                ...
                case ModalsEnum.REMINDER_REMOVE_REPO_ACTION: {
                    ...
                    const updatedReminderModal = await reminderModal({
                        modify: this.modify,
                        read: this.read,
                        persistence: this.persistence,
                        http: this.http,
                    ...
                    return context
                        .getInteractionResponder()
                        .updateModalViewResponse(updatedReminderModal);
                }
            }
        } catch (error) {
            console.log(error);
